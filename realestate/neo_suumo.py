...
OBJECTS = 'div.cassetteitem'
NAME = 'div.cassetteitem_content-title'
ADDRESS = 'li.cassetteitem_detail-col1'
LOC0 = 'div.cassetteitem_detail-text'
LOC1 = 'div.cassetteitem_detail-text'
LOC2 = 'div.cassetteitem_detail-text'
AGE = ''
HEIGHT = ''
FLOOR = ''
FEE = ''
