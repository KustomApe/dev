...
CK = 'PhmPFIDjTcbaxeRmqXqK0KZVR'  # Consumer Key
CS = 'TLIWUadER3B5zySncWwHT7aG1Vyg8evWelvfT9Z9wXXznqQ6uR'  # Consumer Secret
AT = '87425177-4dkwezCSg5Ux58X2NId3WE2XilzzSX9K7hv2KG9KQ'  # Access Token
AS = '6htnT5yE0zgGC67lfHZ4y9DU21jGwufRtDkfXgQZoJKW7'  # Accesss Token Secert
...
if __name__ == '__main__':
    ...
    # キーワードで取得
    getter = TweetsGetter.bySearch(u'走り屋 募集')

    # ユーザーを指定して取得 （screen_name）
    # getter = TweetsGetter.byUser('hikaru3435')
    ...
    #csv出力
    with open('o-ri-search_10.csv', 'w', newline='', encoding='utf-8') as f:
