...
# 第7章の演習5と、in演算子の使い方が分からなかった。 - no1
# 何を使ってどの順番で書くのかを思い出して、頭の中で整理してから手を動かすまでに時間がかかるのでついていくのが難しかったです。 - no2
# 説明が難しいのですが、リスト1とリスト2の中の共通の値を導き出したいときは直訳するとリスト1 in リスト2のようなニュアンスで覚えれば良いのでしょうか
# 演習７の５に関して、どうすれば共通の数字を表示させるのかがわからなかった。 - no3
lst1 = [1, 2, 3, 4, 5, 6]
lst2 = [4, 5, 6, 7, 8, 9]
lst3 = []
...
# また、教科書の6-6のfor分のfor以降の変数は、自分で突然定義するということでしょうか。 - yes
lst5 = [1, 2, 3]
for n in lst5:
    print(n)
